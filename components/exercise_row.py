        ...
        content=ft.Row(
            ...
            controls=[
                ...
                ft.Row(spacing=8, vertical_alignment=ft.CrossAxisAlignment.CENTER, controls=[
                    ...
                    ft.Container(width=60, content=ft.Text(fmt(etapa.duracao), size=16, weight=ft.FontWeight.BOLD,
                        color=ft.Colors.ON_SURFACE if not is_atual else ft.Colors.PRIMARY, font_family="RobotoMono", text_align=ft.TextAlign.RIGHT)),
                ]),
            ],
        ),
    )